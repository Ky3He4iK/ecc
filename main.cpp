...
bool testLongInt() {
    ...
    ASSERT_TEST(LongInt("115792089237316195423570985008687907853269984665640564039457584007913129639935") + 1,
                LongInt("0"), "+1")
    ...
    ASSERT_TEST(LongInt("115792089237316195423570985008687907853269984665640564039457584007913129639936"),
                LongInt("0"), "of")
    ASSERT_TEST(
    ...
    cout << "Combine len:\n";
    ASSERT_TEST(l1 / r1.changeLen(256), LongInt("18565484863282276648"), "/")
    ...
    ASSERT_TEST(ll1.changeLen(2048) * ll2.changeLen(2048), LongInt(

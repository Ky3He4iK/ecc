...
bool test() {
    ...
    ASSERT(LongInt(192, r1 % 45), LongInt(30, "15").changeLen(192), "%")
    ...
    ASSERT(l2 % l1, LongInt(256, "80664189130459777991682472803529513370"), "%")
    ASSERT(LongInt(256, l1 % 45), LongInt(32, "24").changeLen(256), "%")
    ...
    cout << "Combine len:\n";
    ASSERT(l1 / r1.changeLen(256), LongInt(256, "18565484863282276648"), "/")
